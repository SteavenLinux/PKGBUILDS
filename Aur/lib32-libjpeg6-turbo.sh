...
rm -rf ~/ah/lib32-libjpeg6-turbo
cp -r lib32-libjpeg6-turbo ~/ah/lib32-libjpeg6-turbo

# Move to build directory
cd ~/ah/lib32-libjpeg6-turbo || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/lib32-libjpeg6-turbo*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/lib32-libjpeg6-turbo*.pkg.tar.zst.sig
