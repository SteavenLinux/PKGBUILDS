...
rm -rf ~/ah/libsoup
cp -r libsoup ~/ah/libsoup

# Move to build directory
cd ~/ah/libsoup || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libsoup*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libsoup*.pkg.tar.zst.sig
