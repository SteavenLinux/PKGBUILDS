...
rm -rf ~/ah/wiiudownloader
cp -r wiiudownloader ~/ah/wiiudownloader

# Move to build directory
cd ~/ah/wiiudownloader || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/wiiudownloader*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/wiiudownloader*.pkg.tar.zst.sig
