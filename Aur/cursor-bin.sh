...
rm -rf ~/ah/cursor-bin
cp -r cursor-bin ~/ah/cursor-bin

# Move to build directory
cd ~/ah/cursor-bin || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/cursor-bin*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/cursor-bin*.pkg.tar.zst.sig
