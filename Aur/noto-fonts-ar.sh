...
rm -f /home/omarhanykasban/SteavenRepo/x86_64/noto-fonts-ar*.pkg.tar.zst
rm -f /home/omarhanykasban/SteavenRepo/x86_64/noto-fonts-ar*.pkg.tar.zst.sig

# Copy new package and signature to the repo
cp noto-fonts-ar*.pkg.tar.zst /home/omarhanykasban/SteavenRepo/x86_64
cp noto-fonts-ar*.pkg.tar.zst.sig /home/omarhanykasban/SteavenRepo/x86_64
