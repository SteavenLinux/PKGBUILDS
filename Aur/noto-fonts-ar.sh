...
rm -f /mnt/nvme/SteavenRepo/x86_64/noto-fonts-ar*.pkg.tar.zst
rm -f /mnt/nvme/SteavenRepo/x86_64/noto-fonts-ar*.pkg.tar.zst.sig

# Copy new package and signature to the repo
cp noto-fonts-ar*.pkg.tar.zst /mnt/nvme/SteavenRepo/x86_64
cp noto-fonts-ar*.pkg.tar.zst.sig /mnt/nvme/SteavenRepo/x86_64
