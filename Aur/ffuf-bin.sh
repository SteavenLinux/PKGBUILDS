...
rm -rf ~/ah/ffuf-bin
cp -r ffuf-bin ~/ah/ffuf-bin

# Move to build directory
cd ~/ah/ffuf-bin || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/ffuf-bin*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/ffuf-bin*.pkg.tar.zst.sig
