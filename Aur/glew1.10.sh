...
rm -rf ~/ah/glew1.10
cp -r glew1.10 ~/ah/glew1.10

# Move to build directory
cd ~/ah/glew1.10 || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/glew1.10*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/glew1.10*.pkg.tar.zst.sig
