...
rm -rf ~/ah/an-anime-game-launcher-bin
cp -r an-anime-game-launcher-bin ~/ah/an-anime-game-launcher-bin

# Move to build directory
cd ~/ah/an-anime-game-launcher-bin || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/an-anime-game-launcher-bin*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/an-anime-game-launcher-bin*.pkg.tar.zst.sig
