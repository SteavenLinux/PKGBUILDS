...
rm -rf ~/ah/clutter
cp -r clutter ~/ah/clutter

# Move to build directory
cd ~/ah/clutter || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/clutter*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/clutter*.pkg.tar.zst.sig
