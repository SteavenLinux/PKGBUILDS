...
rm -f /mnt/hdd/SteavenRepo/x86_64/gnome-shell-extension-alphabetical-grid-extension*.pkg.tar.zst
rm -f /mnt/hdd/SteavenRepo/x86_64/gnome-shell-extension-alphabetical-grid-extension*.pkg.tar.zst.sig
