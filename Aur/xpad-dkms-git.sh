...
rm -rf ~/ah/xpad-dkms-git
cp -r xpad-dkms-git ~/ah/xpad-dkms-git

# Move to build directory
cd ~/ah/xpad-dkms-git || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/xpad-dkms-git*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/xpad-dkms-git*.pkg.tar.zst.sig
