...
rm -rf ~/ah/openssl-1.1
cp -r openssl-1.1 ~/ah/openssl-1.1

# Move to build directory
cd ~/ah/openssl-1.1 || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/openssl-1.1*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/openssl-1.1*.pkg.tar.zst.sig
