...
rm -rf ~/ah/libudev0-shim
cp -r libudev0-shim ~/ah/libudev0-shim

# Move to build directory
cd ~/ah/libudev0-shim || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libudev0-shim*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libudev0-shim*.pkg.tar.zst.sig
