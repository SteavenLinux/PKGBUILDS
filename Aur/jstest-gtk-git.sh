...
rm -rf ~/ah/jstest-gtk-git
cp -r jstest-gtk-git ~/ah/jstest-gtk-git

# Move to build directory
cd ~/ah/jstest-gtk-git || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/jstest-gtk-git*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/jstest-gtk-git*.pkg.tar.zst.sig
