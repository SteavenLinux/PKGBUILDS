...
rm -rf ~/ah/sunshine-bin
cp -r sunshine-bin ~/ah/sunshine-bin

# Move to build directory
cd ~/ah/sunshine-bin || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/sunshine-bin*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/sunshine-bin*.pkg.tar.zst.sig
