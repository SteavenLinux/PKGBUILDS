...
rm -rf ~/ah/nautilus-backspace
cp -r nautilus-backspace ~/ah/nautilus-backspace

# Move to build directory
cd ~/ah/nautilus-backspace || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/nautilus-backspace*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/nautilus-backspace*.pkg.tar.zst.sig
