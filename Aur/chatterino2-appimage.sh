...
rm -rf ~/ah/chatterino2-appimage
cp -r chatterino2-appimage ~/ah/chatterino2-appimage

# Move to build directory
cd ~/ah/chatterino2-appimage || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/nvme/SteavenRepo/x86_64/chatterino2-appimage*.pkg.tar.zst
rm -f /mnt/nvme/SteavenRepo/x86_64/chatterino2-appimage*.pkg.tar.zst.sig
