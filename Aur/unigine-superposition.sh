...
rm -f /home/omarhanykasban/SteavenRepo/x86_64/unigine-superposition*.pkg.tar.zst
rm -f /home/omarhanykasban/SteavenRepo/x86_64/unigine-superposition*.pkg.tar.zst.sig

# Copy new package and signature to the repo
cp unigine-superposition*.pkg.tar.zst /home/omarhanykasban/SteavenRepo/x86_64
cp unigine-superposition*.pkg.tar.zst.sig /home/omarhanykasban/SteavenRepo/x86_64
