...
rm -rf ~/ah/libpng12
cp -r libpng12 ~/ah/libpng12

# Move to build directory
cd ~/ah/libpng12 || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libpng12*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libpng12*.pkg.tar.zst.sig
