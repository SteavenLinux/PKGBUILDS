...
rm -rf ~/ah/clamav-gui
cp -r clamav-gui ~/ah/clamav-gui

# Move to build directory
cd ~/ah/clamav-gui || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-Old-PC/home/omarhanykasban/SteavenRepo/x86_64/clamav-gui*.pkg.tar.zst
rm -f /mnt/Omar-Old-PC/home/omarhanykasban/SteavenRepo/x86_64/clamav-gui*.pkg.tar.zst.sig
