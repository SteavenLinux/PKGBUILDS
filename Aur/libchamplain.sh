...
rm -rf ~/ah/libchamplain
cp -r libchamplain ~/ah/libchamplain

# Move to build directory
cd ~/ah/libchamplain || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libchamplain*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libchamplain*.pkg.tar.zst.sig
