...
rm -rf ~/ah/hiddify
cp -r hiddify ~/ah/hiddify

# Move to build directory
cd ~/ah/hiddify || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/hiddify*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/hiddify*.pkg.tar.zst.sig
