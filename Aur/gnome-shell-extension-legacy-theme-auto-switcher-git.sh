...
rm -f /mnt/nvme/SteavenRepo/x86_64/gnome-shell-extension-legacy-theme-auto-switcher-git*.pkg.tar.zst
rm -f /mnt/nvme/SteavenRepo/x86_64/gnome-shell-extension-legacy-theme-auto-switcher-git*.pkg.tar.zst.sig
