...
rm -rf ~/ah/libgcrypt15
cp -r libgcrypt15 ~/ah/libgcrypt15

# Move to build directory
cd ~/ah/libgcrypt15 || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libgcrypt15*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libgcrypt15*.pkg.tar.zst.sig
