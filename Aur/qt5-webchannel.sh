...
rm -rf ~/ah/qt5-webchannel
cp -r qt5-webchannel ~/ah/qt5-webchannel

# Move to build directory
cd ~/ah/qt5-webchannel || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/qt5-webchannel*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/qt5-webchannel*.pkg.tar.zst.sig
