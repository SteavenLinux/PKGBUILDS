...
rm -rf ~/ah/libmaddy
cp -r libmaddy ~/ah/libmaddy

# Move to build directory
cd ~/ah/libmaddy || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libmaddy*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libmaddy*.pkg.tar.zst.sig
