...
rm -rf ~/ah/parabolic
cp -r parabolic ~/ah/parabolic

# Move to build directory
cd ~/ah/parabolic || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/parabolic*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/parabolic*.pkg.tar.zst.sig
