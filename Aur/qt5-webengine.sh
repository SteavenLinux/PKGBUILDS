...
rm -rf ~/ah/qt5-webengine
cp -r qt5-webengine ~/ah/qt5-webengine

# Move to build directory
cd ~/ah/qt5-webengine || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/qt5-webengine*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/qt5-webengine*.pkg.tar.zst.sig
