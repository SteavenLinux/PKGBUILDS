...
rm -f /mnt/Omar-Old-PC/mnt/nvme/SteavenRepo/x86_64/grimshot-bin-sway*.pkg.tar.zst
rm -f /mnt/Omar-Old-PC/mnt/nvme/SteavenRepo/x86_64/grimshot-bin-sway*.pkg.tar.zst.sig
