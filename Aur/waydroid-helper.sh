...
rm -f /home/omarhanykasban/SteavenRepo/x86_64/waydroid-helper*.pkg.tar.zst
rm -f /home/omarhanykasban/SteavenRepo/x86_64/waydroid-helper*.pkg.tar.zst.sig

# Copy new package and signature to the repo
cp waydroid-helper*.pkg.tar.zst /home/omarhanykasban/SteavenRepo/x86_64
cp waydroid-helper*.pkg.tar.zst.sig /home/omarhanykasban/SteavenRepo/x86_64
