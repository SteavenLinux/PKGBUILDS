...
rm -rf ~/ah/clutter-gtk
cp -r clutter-gtk ~/ah/clutter-gtk

# Move to build directory
cd ~/ah/clutter-gtk || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/clutter-gtk*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/clutter-gtk*.pkg.tar.zst.sig
