...
rm -rf ~/ah/xwaylandvideobridge
cp -r xwaylandvideobridge ~/ah/xwaylandvideobridge

# Move to build directory
cd ~/ah/xwaylandvideobridge || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/xwaylandvideobridge*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/xwaylandvideobridge*.pkg.tar.zst.sig
