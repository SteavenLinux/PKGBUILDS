...
rm -f /home/omarhanykasban/SteavenRepo/x86_64/obs-pipewire-audio-capture-bin*.pkg.tar.zst
rm -f /home/omarhanykasban/SteavenRepo/x86_64/obs-pipewire-audio-capture-bin*.pkg.tar.zst.sig

# Copy new package and signature to the repo
cp obs-pipewire-audio-capture-bin*.pkg.tar.zst /home/omarhanykasban/SteavenRepo/x86_64
cp obs-pipewire-audio-capture-bin*.pkg.tar.zst.sig /home/omarhanykasban/SteavenRepo/x86_64
