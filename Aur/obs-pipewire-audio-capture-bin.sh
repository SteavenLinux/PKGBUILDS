...
rm -f /mnt/Omar-Old-PC/home/omarhanykasban/SteavenRepo/x86_64/obs-pipewire-audio-capture-bin*.pkg.tar.zst
rm -f /mnt/Omar-Old-PC/home/omarhanykasban/SteavenRepo/x86_64/obs-pipewire-audio-capture-bin*.pkg.tar.zst.sig
