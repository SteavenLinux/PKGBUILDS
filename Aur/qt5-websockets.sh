...
rm -rf ~/ah/qt5-websockets
cp -r qt5-websockets ~/ah/qt5-websockets

# Move to build directory
cd ~/ah/qt5-websockets || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/qt5-websockets*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/qt5-websockets*.pkg.tar.zst.sig
