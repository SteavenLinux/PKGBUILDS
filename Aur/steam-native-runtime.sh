...
rm -rf ~/ah/steam-native-runtime
cp -r steam-native-runtime ~/ah/steam-native-runtime

# Move to build directory
cd ~/ah/steam-native-runtime || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/steam-native-runtime*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/steam-native-runtime*.pkg.tar.zst.sig
