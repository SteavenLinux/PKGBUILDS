...
rm -rf ~/ah/lib32-libvpx1.3
cp -r lib32-libvpx1.3 ~/ah/lib32-libvpx1.3

# Move to build directory
cd ~/ah/lib32-libvpx1.3 || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/lib32-libvpx1.3*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/lib32-libvpx1.3*.pkg.tar.zst.sig
