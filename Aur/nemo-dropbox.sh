...
rm -rf ~/ah/nemo-dropbox
cp -r nemo-dropbox ~/ah/nemo-dropbox

# Move to build directory
cd ~/ah/nemo-dropbox || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/nemo-dropbox*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/nemo-dropbox*.pkg.tar.zst.sig
