...
rm -f /mnt/Omar-Old-PC/mnt/nvme/SteavenRepo/x86_64/vulkan-memory-allocator*.pkg.tar.zst
rm -f /mnt/Omar-Old-PC/mnt/nvme/SteavenRepo/x86_64/vulkan-memory-allocator*.pkg.tar.zst.sig
