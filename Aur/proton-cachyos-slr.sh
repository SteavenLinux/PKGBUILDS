...
rm -f /mnt/Omar-Old-PC/mnt/nvme/SteavenRepo/x86_64/proton-cachyos-slr*.pkg.tar.zst
rm -f /mnt/Omar-Old-PC/mnt/nvme/SteavenRepo/x86_64/proton-cachyos-slr*.pkg.tar.zst.sig
