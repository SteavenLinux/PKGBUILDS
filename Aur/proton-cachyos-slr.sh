...
rm -rf ~/ah/proton-cachyos-slr
cp -r proton-cachyos-slr ~/ah/proton-cachyos-slr

# Move to build directory
cd ~/ah/proton-cachyos-slr || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/proton-cachyos-slr*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/proton-cachyos-slr*.pkg.tar.zst.sig
