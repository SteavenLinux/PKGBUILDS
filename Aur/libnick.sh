...
rm -rf ~/ah/libnick
cp -r libnick ~/ah/libnick

# Move to build directory
cd ~/ah/libnick || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libnick*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libnick*.pkg.tar.zst.sig
