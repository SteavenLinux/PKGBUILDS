...
rm -rf ~/ah/jellyfin-desktop
cp -r jellyfin-desktop ~/ah/jellyfin-desktop

# Move to build directory
cd ~/ah/jellyfin-desktop || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/jellyfin-desktop*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/jellyfin-desktop*.pkg.tar.zst.sig
