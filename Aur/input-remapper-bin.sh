...
rm -rf ~/ah/input-remapper-bin
cp -r input-remapper-bin ~/ah/input-remapper-bin

# Move to build directory
cd ~/ah/input-remapper-bin || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/input-remapper-bin*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/input-remapper-bin*.pkg.tar.zst.sig
