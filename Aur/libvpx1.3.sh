...
rm -rf ~/ah/libvpx1.3
cp -r libvpx1.3 ~/ah/libvpx1.3

# Move to build directory
cd ~/ah/libvpx1.3 || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libvpx1.3*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libvpx1.3*.pkg.tar.zst.sig
