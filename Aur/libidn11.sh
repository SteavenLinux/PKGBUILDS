...
rm -rf ~/ah/libidn11
cp -r libidn11 ~/ah/libidn11

# Move to build directory
cd ~/ah/libidn11 || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libidn11*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/libidn11*.pkg.tar.zst.sig
