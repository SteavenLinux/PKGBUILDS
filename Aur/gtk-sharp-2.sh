...
rm -rf ~/ah/gtk-sharp-2
cp -r gtk-sharp-2 ~/ah/gtk-sharp-2

# Move to build directory
cd ~/ah/gtk-sharp-2 || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/gtk-sharp-2*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/gtk-sharp-2*.pkg.tar.zst.sig
