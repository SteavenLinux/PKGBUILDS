...
rm -f /mnt/Omar-Old-PC/mnt/nvme/SteavenRepo/x86_64/whitesur-cursor-theme-git*.pkg.tar.zst
rm -f /mnt/Omar-Old-PC/mnt/nvme/SteavenRepo/x86_64/whitesur-cursor-theme-git*.pkg.tar.zst.sig
