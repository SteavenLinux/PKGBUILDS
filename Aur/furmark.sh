...
rm -rf ~/ah/furmark
cp -r furmark ~/ah/furmark

# Move to build directory
cd ~/ah/furmark || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/furmark*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/furmark*.pkg.tar.zst.sig
