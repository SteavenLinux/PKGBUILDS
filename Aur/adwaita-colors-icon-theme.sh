...
rm -rf ~/ah/adwaita-colors-icon-theme
cp -r adwaita-colors-icon-theme ~/ah/adwaita-colors-icon-theme

# Move to build directory
cd ~/ah/adwaita-colors-icon-theme || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/adwaita-colors-icon-theme*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/adwaita-colors-icon-theme*.pkg.tar.zst.sig
