...
rm -f /mnt/Omar-Old-PC/mnt/nvme/SteavenRepo/x86_64/adwaita-colors-icon-theme*.pkg.tar.zst
rm -f /mnt/Omar-Old-PC/mnt/nvme/SteavenRepo/x86_64/adwaita-colors-icon-theme*.pkg.tar.zst.sig
