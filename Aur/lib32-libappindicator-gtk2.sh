...
rm -rf ~/ah/lib32-libappindicator-gtk2
cp -r lib32-libappindicator-gtk2 ~/ah/lib32-libappindicator-gtk2

# Move to build directory
cd ~/ah/lib32-libappindicator-gtk2 || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/lib32-libappindicator-gtk2*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/lib32-libappindicator-gtk2*.pkg.tar.zst.sig
