...
rm -rf ~/ah/kesl-gui
cp -r kesl-gui ~/ah/kesl-gui

# Move to build directory
cd ~/ah/kesl-gui || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/kesl-gui*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/kesl-gui*.pkg.tar.zst.sig
