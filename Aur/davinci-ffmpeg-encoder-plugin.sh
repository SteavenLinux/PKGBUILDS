...
rm -f /mnt/hdd/SteavenRepo/x86_64/davinci-ffmpeg-encoder-plugin*.pkg.tar.zst
rm -f /mnt/hdd/SteavenRepo/x86_64/davinci-ffmpeg-encoder-plugin*.pkg.tar.zst.sig
