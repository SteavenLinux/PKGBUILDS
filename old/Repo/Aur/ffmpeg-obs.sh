...
rm -rf /mnt/nvme/SteavenRepo/x86_64/ffmpeg-obs*.pkg.tar.zst
rm -rf /mnt/nvme/SteavenRepo/x86_64/ffmpeg-obs*.pkg.tar.zst.sig
cp ffmpeg-obs*.pkg.tar.zst /mnt/nvme/SteavenRepo/x86_64/
cp ffmpeg-obs*.pkg.tar.zst.sig /mnt/nvme/SteavenRepo/x86_64/
