...
rm -rf /mnt/hdd/SteavenRepo/x86_64/ffmpeg-obs*.pkg.tar.zst
rm -rf /mnt/hdd/SteavenRepo/x86_64/ffmpeg-obs*.pkg.tar.zst.sig
cp ffmpeg-obs*.pkg.tar.zst /mnt/hdd/SteavenRepo/x86_64/
cp ffmpeg-obs*.pkg.tar.zst.sig /mnt/hdd/SteavenRepo/x86_64/
