...
rm -rf /mnt/nvme/SteavenRepo/x86_64/linux-vfio*.pkg.tar.zst
rm -rf /mnt/nvme/SteavenRepo/x86_64/linux-vfio*.pkg.tar.zst.sig
cp linux-vfio*.pkg.tar.zst /mnt/nvme/SteavenRepo/x86_64/
cp linux-vfio*.pkg.tar.zst.sig /mnt/nvme/SteavenRepo/x86_64/
