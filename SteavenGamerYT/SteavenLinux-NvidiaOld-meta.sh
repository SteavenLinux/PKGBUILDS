...
rm -rf ~/ah/SteavenLinux-NvidiaOld-meta
cp -r SteavenLinux-NvidiaOld-meta ~/ah/SteavenLinux-NvidiaOld-meta

# Move to build directory
cd ~/ah/SteavenLinux-NvidiaOld-meta || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/hdd/SteavenRepo/x86_64/SteavenLinux-NvidiaOld-meta*.pkg.tar.zst
rm -f /mnt/hdd/SteavenRepo/x86_64/SteavenLinux-NvidiaOld-meta*.pkg.tar.zst.sig
