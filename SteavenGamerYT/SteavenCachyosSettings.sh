...
rm -rf ~/ah/SteavenCachyosSettings
cp -r SteavenCachyosSettings ~/ah/SteavenCachyosSettings

# Move to build directory
cd ~/ah/SteavenCachyosSettings || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/SteavenCachyosSettings*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/SteavenCachyosSettings*.pkg.tar.zst.sig
