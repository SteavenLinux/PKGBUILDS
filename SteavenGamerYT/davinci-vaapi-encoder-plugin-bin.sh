...
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/davinci-vaapi-encoder-plugin-bin*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/davinci-vaapi-encoder-plugin-bin*.pkg.tar.zst.sig
