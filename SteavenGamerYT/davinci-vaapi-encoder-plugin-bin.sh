...
rm -f /mnt/Omar-Old-PC/mnt/nvme/SteavenRepo/x86_64/davinci-vaapi-encoder-plugin-bin*.pkg.tar.zst
rm -f /mnt/Omar-Old-PC/mnt/nvme/SteavenRepo/x86_64/davinci-vaapi-encoder-plugin-bin*.pkg.tar.zst.sig
