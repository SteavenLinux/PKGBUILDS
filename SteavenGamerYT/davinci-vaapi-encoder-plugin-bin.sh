...
rm -f /mnt/hdd/SteavenRepo/x86_64/davinci-vaapi-encoder-plugin-bin*.pkg.tar.zst
rm -f /mnt/hdd/SteavenRepo/x86_64/davinci-vaapi-encoder-plugin-bin*.pkg.tar.zst.sig
