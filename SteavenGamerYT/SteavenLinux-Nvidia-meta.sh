...
rm -rf ~/ah/SteavenLinux-Nvidia-meta
cp -r SteavenLinux-Nvidia-meta ~/ah/SteavenLinux-Nvidia-meta

# Move to build directory
cd ~/ah/SteavenLinux-Nvidia-meta || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/hdd/SteavenRepo/x86_64/SteavenLinux-Nvidia-meta*.pkg.tar.zst
rm -f /mnt/hdd/SteavenRepo/x86_64/SteavenLinux-Nvidia-meta*.pkg.tar.zst.sig
