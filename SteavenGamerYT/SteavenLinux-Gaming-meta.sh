...
rm -rf ~/ah/SteavenLinux-Gaming-meta
cp -r SteavenLinux-Gaming-meta ~/ah/SteavenLinux-Gaming-meta

# Move to build directory
cd ~/ah/SteavenLinux-Gaming-meta || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/SteavenLinux-Gaming-meta*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/SteavenLinux-Gaming-meta*.pkg.tar.zst.sig
