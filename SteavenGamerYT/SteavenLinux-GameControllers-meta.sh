...
rm -rf ~/ah/SteavenLinux-GameControllers-meta
cp -r SteavenLinux-GameControllers-meta ~/ah/SteavenLinux-GameControllers-meta

# Move to build directory
cd ~/ah/SteavenLinux-GameControllers-meta || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/hdd/SteavenRepo/x86_64/SteavenLinux-GameControllers-meta*.pkg.tar.zst
rm -f /mnt/hdd/SteavenRepo/x86_64/SteavenLinux-GameControllers-meta*.pkg.tar.zst.sig
