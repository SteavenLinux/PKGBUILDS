...
rm -rf ~/ah/SteavenLinux-Ryzen-meta
cp -r SteavenLinux-Ryzen-meta ~/ah/SteavenLinux-Ryzen-meta

# Move to build directory
cd ~/ah/SteavenLinux-Ryzen-meta || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/hdd/SteavenRepo/x86_64/SteavenLinux-Ryzen-meta*.pkg.tar.zst
rm -f /mnt/hdd/SteavenRepo/x86_64/SteavenLinux-Ryzen-meta*.pkg.tar.zst.sig
