...
rm -rf ~/ah/freedownloadmanager
cp -r freedownloadmanager ~/ah/freedownloadmanager

# Move to build directory
cd ~/ah/freedownloadmanager || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/nvme/SteavenRepo/x86_64/freedownloadmanager*.pkg.tar.zst
rm -f /mnt/nvme/SteavenRepo/x86_64/freedownloadmanager*.pkg.tar.zst.sig
