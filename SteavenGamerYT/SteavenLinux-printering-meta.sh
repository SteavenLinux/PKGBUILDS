...
rm -f /mnt/nvme/SteavenRepo/x86_64/SteavenLinux-printering-meta*.pkg.tar.zst
rm -f /mnt/nvme/SteavenRepo/x86_64/SteavenLinux-printering-meta*.pkg.tar.zst.sig
