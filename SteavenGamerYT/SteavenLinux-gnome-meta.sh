...
rm -rf ~/ah/SteavenLinux-gnome-meta
cp -r SteavenLinux-gnome-meta ~/ah/SteavenLinux-gnome-meta

# Move to build directory
cd ~/ah/SteavenLinux-gnome-meta || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/SteavenLinux-gnome-meta*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/SteavenLinux-gnome-meta*.pkg.tar.zst.sig
