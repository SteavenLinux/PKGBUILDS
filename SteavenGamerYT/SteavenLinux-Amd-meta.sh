...
rm -rf ~/ah/SteavenLinux-Amd-meta
cp -r SteavenLinux-Amd-meta ~/ah/SteavenLinux-Amd-meta

# Move to build directory
cd ~/ah/SteavenLinux-Amd-meta || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/SteavenLinux-Amd-meta*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/SteavenLinux-Amd-meta*.pkg.tar.zst.sig
