...
rm -rf ~/ah/SteavenLinux-Plymouth
cp -r SteavenLinux-Plymouth ~/ah/SteavenLinux-Plymouth

# Move to build directory
cd ~/ah/SteavenLinux-Plymouth || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/SteavenLinux-Plymouth*.pkg.tar.zst
rm -f /mnt/Omar-PC-Server/home/omarhanykasban/SteavenRepo/x86_64/SteavenLinux-Plymouth*.pkg.tar.zst.sig
