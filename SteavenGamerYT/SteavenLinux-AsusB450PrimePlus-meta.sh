...
rm -rf ~/ah/SteavenLinux-AsusB450PrimePlus-meta
cp -r SteavenLinux-AsusB450PrimePlus-meta ~/ah/SteavenLinux-AsusB450PrimePlus-meta

# Move to build directory
cd ~/ah/SteavenLinux-AsusB450PrimePlus-meta || exit 1

# Build and sign package
makepkg -sr --sign || exit 1

# Remove old package and signature from the repo
rm -f /mnt/hdd/SteavenRepo/x86_64/SteavenLinux-AsusB450PrimePlus-meta*.pkg.tar.zst
rm -f /mnt/hdd/SteavenRepo/x86_64/SteavenLinux-AsusB450PrimePlus-meta*.pkg.tar.zst.sig
